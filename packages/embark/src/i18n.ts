...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "liveExample.heading": "embark.blpsoares.dev",
    "liveExample.desc": "The site you're reading right now is a package inside the Embark monorepo. It was created with <code>bun run new-package</code>, committed, and automatically deployed via GitHub Actions — no config written by hand. It lives at <code>embark.blpsoares.dev</code> as a subdomain package of this repo.",
    "liveExample.fact1": "📦 Package: <code>packages/embark</code>",
    "liveExample.fact2": "🚀 Deploy: Cloudflare Pages",
    "liveExample.fact3": "🌐 Domain: <code>embark.blpsoares.dev</code> (subdomain)",
    ...
    "start.step2.desc": "Run the init script to clean up demo files and optionally remove Git history. Start fresh with your own repo.",
  ...
  pt: {
    ...
    "start.step2.desc": "Execute o script init para limpar arquivos demo e opcionalmente remover histórico Git. Comece do zero com seu próprio repo.",
